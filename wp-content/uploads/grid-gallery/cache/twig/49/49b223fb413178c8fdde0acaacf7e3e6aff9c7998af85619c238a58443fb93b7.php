...
class __TwigTemplate_02ab67c05027ffef709fc7b09b2238333edbdbce122a5a4076839a038d9d5a0f extends Twig_SupTwg_Template
{
    ...
    public function block_header($context, array $blocks = array())
    {
        ...
        echo "\">";
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Create new gallery")), "html", null, true);
        echo "</a>
    </nav>";
    }
    ...
    <h3 style=\"margin-left: 10px;padding-bottom: 10px !important;border-bottom: 1px solid;\">";
        // line 38
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Choose Gallery Template. You can change template and settings on the next step.")), "html", null, true);
        echo "</h3>
...
\t\t</h3>
        ...
        $context['_seq'] = Twig_SupTwg_ensure_traversable(($context["presets"] ?? null));
...
\t\ttitle=\"";
        ...
        data-preset=\"";
            ...
            if (($this->getAttribute(($context["data"] ?? null), "pro", array()) && ($this->getAttribute(($context["environment"] ?? null), "isPro", array(), "method") == false))) {
                ...
                echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["data"] ?? null), "link", array()), "html", null, true);
                echo "'\" src=\"";
            ...
            <div style=\"position: absolute; top: 50%; left: 50%; transform:translate(-50%, -50%); display:table;\">
                ...
                // line 18
                echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Selected")), "html", null, true);
                echo "</span>
            </div>";
            }
            // line 21
    ...
    {
        return new Twig_SupTwg_Source("", "@galleries/gallery_preset.twig", "C:\\xampp\\htdocs\\4window\\wp-content\\plugins\\gallery-by-supsystic\\src\\GridGallery\\Galleries\\views\\gallery_preset.twig");
    }
}
