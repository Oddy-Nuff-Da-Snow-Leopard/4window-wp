...
class DisplaySettings
{
    ...
    public function get_toggle_settings()
    {
        ...
        $settings = [
            ...
            "description" => Utils::t( "For example, FontAwesome icons need classes like \"fa fa-angle-down\". " ) . Utils::t( "Note: you should include custom icons pack in your theme by yourself" ),
